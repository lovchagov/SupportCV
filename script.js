const langRU = {
    ...
    'work': ['Опыт работы', 'Ростелеком', 'Инженер технической поддержки первой категории (2ая линия) (B2C)', 'Декабрь 2018 - Сентябрь 2020', '<p> Основные обязанности: </p> Диагностировал и решал проблемы с сетью, телевидением, SIP-телефонией. Осуществлял мониторинг сети. Создавал и эскалировал массовые инциденты, a также взаимодействал со смежными подразделениями для устранения инцидентов. <p> Ключевые достижения: </p> Получил повышение до инженера первой категории , стал дежурным инженером, в вечернее и ночное время выполнял часть обязанностей руководителя группы технической поддержки. В частности: помощь и руководство небольшой группой сотрудников.', 'Инженер технической поддержки (B2B)', 'Октябрь 2020 - Сентябрь 2021','<p> Основные обязанности: </p>   Диагностировал и решал проблемы, связанные с сетью, телевидением, ПК пользователей. Взаимодействовал с отелями и производетелями оборудования со всего мира. Взаимодействал с сотрудниками других отделов для решения инцидентов. Выполнял часть обязанностей системного администратора. <p> Ключевые достижения: </p> Централизировал и ускорил работу it-отдела в пределах работы технической поддержки клиентов. Ускорил работу и внёс изменения в работу локальной технической поддержки.', 'Газпром-нефть ИТО', 'Ведущий специалист отдела мониторинга инфраструктуры', 'Октябрь 2021 - Октябрь 2022', '<p> Основные обязанности: </p>  Координировал специалистов технической поддержки в рамках бизнес-критичных систем. Осуществлял мониторинг сетевого и серверного обрудования в рамках бизнес-критичных систем. Создавал и эскалировал массовые инциденты Взаимодействал с сотрудниками других отделов для решения инцидентов. <p> Ключевые достижения: </p>  За время работы предотвратил около 15 критичных инцидентов, остановивших отгрузку нефтепродуктов, тем самых избавив компанию от больших финансовых потерь. В качестве наставника за месяц подготовил и научил нового сотрудника к самостоятельной работе в дежурную смену.'] };
...
const langEN = {
    ...
    'language': ['Language', 'English', 'Intermediate (I worked as Technical Support Engineer and communicated with staff from different countries by e-mail and phone calls)', 'Russian', 'Native'],
    'skills': ['Skills', 'Basic skills', 'Network', 'Switches: CLI of different vendors (Cisco, Huawei, Brocade etc), mainly L2 - Basic Configuration and Diagnosing', 'Controllers: Aruba, Ruckus - Basic Configuration and Diagnosing', 'Monitoring: Grafana, Solarwinds', 'SIP: VOIP-Gateways of different vendors and SIP-telephones', 'Also have experience with WEB-Interface of different ADSL-modems, ONTS, OLTs, wireless routers, access points and another network staff'],
    'work': ['Experience', 'Rostelecom', 'First category technical support engineer (Tier 2) (B2C)', 'December 2018 - September 2020', '<p> Key Responsibilities </p> Troubleshot and resolved issues with network, TV-systems, SIP. Monitored network. Created and escalated mass incidents. Communicated with other departments for fast resolve incidents. <p> Key Achievements: </p> I was promoted to engineer of the first category, became an engineer on duty, in the evening and at night performed part of the duties of the head of the technical support group. In particular: assistance and management of a small group of employees. Resolved about 1000+ tickets.', 'Technical support engineer (B2B)', 'October 2020 - September 2021', '<p> Key Responsibilities </p> Troubleshot and resolved issues with network, TV-systems, users\'s PCs. Communicated with hotels and vendors of different countries. Communicated with other departments for fast resolve issues. <p> Key Achievements </p> Centralized and accelerated the work of the IT department within the work of technical support of clients. Accelerated the work and made changes to the technical support work. Resolved about 100+ tickets.', 'Gazprom-Neft ITO', 'Leading Specialist of Infrastructure Monitoring Department', 'October 2021 - October 2022', ' <p> Key Responsibilities. </p> Coordinated of technical support staff within business-critical services. Monitored network and servers within business-critical services. Creatied and escalated mass incidents. Communicated with another departments for fast resolve incidents. <p> Key Achievements. </p> During my work, I prevented about 15 critical incidents that stopped the shipment of petroleum products, thus saving the company a large financial loss. As a mentor, I trained and coached a new employee for a month to work independently on duty shift']
}
